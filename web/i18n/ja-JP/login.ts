const translation = {
  pageTitle: 'はじめましょう！👋',
  welcome: 'Ghost flowerへようこそ。続行するにはログインしてください。',
  email: 'メールアドレス',
  ...
  license: {
    tip: 'GitHubのオープンソースライセンスを確認してから、Ghost flower Community Editionを開始してください。',
    link: 'オープンソースライセンス',
  },
  join: '参加する',
  ...
  resetPasswordDesc: 'Ghost flowerへのサインアップに使用したメールアドレスを入力すると、パスワードリセットメールが送信されます。',
  licenseLost: 'ライセンスを失った',
  licenseExpiredTip: 'ワークスペースの Ghost flower Enterprise ライセンスの有効期限が切れています。Ghost flowerを引き続き使用するには、管理者に連絡してください。',
  licenseInactive: 'ライセンスが非アクティブです',
  licenseInactiveTip: 'ワークスペースの Ghost flower Enterprise ライセンスが非アクティブです。Ghost flowerを引き続き使用するには、管理者に連絡してください。',
  licenseExpired: 'ライセンスの有効期限が切れています',
  licenseLostTip: 'Ghost flowerライセンスサーバーへの接続に失敗しました。続けてGhost flowerを使用するために管理者に連絡してください。',
}
