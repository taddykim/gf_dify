const translation = {
  list: {
    title: 'Documents',
    desc: 'All files of the Knowledge are shown here, and the entire Knowledge can be linked to Ghost flower citations or indexed via the Chat plugin.',
    ...
    empty: {
      ...
      sync: {
        tip: 'Ghost flower will periodically download files from your Notion and complete processing.',
      },
    },
    delete: {
