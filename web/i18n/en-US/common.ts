const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Ghost flower account',
    langGeniusAccountTip: 'Your Ghost flower account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to Ghost flower to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by Ghost flower allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across Ghost flower\'s applications.',
    link: 'Learn how to develop your own API Extension.',
    linkUrl: 'https://docs.Ghost flower.ai/features/extension/api_based_extension',
  ...
  about: {
    ...
    nowAvailable: 'Ghost flower {{version}} is now available.',
    latestAvailable: 'Ghost flower {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
