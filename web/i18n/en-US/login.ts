const translation = {
  ...
  welcome: '👋 Welcome to Ghost flower, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting Ghost flower Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on Ghost flower',
  invalid: 'The link has expired',
  explore: 'Explore Ghost flower',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on Ghost flower and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The Ghost flower Enterprise license for your workspace has expired. Please contact your administrator to continue using Ghost flower.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect Ghost flower license server. Please contact your administrator to continue using Ghost flower.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The Ghost flower Enterprise license for your workspace is inactive. Please contact your administrator to continue using Ghost flower.',
}
