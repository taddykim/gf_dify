...
import LogoSiteAbout from '@/app/components/base/logo/logo-site-about'
  ...
  return (
    ...
    >
      <div className='relative pt-4'>
        ...
        <div>
          <LogoSiteAbout className='mx-auto mb-2' />
          <div className='mb-3 text-center text-xs font-normal text-gray-500'>Version {langeniusVersionInfo?.current_version}</div>
          <div className='mb-4 text-center text-xs font-normal text-gray-700'>
            <div>© {dayjs().year()} KNOCK LAB, Inc. All rights reserved. Powered by Dify</div>
            <div className='text-[#1C64F2]'>
              <Link href={'https://www.ghost-flower.com'} target='_blank' rel='noopener noreferrer'>Ghost Flower Site</Link>
            </div>
          </div>
        </div>
